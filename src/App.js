...
class BooksApp extends React.Component {
  ...
  moveBook = (id, from, to) => {
    ...
    const updatedFrom = [...this.state[from]];
    ...
    // die neue lösung erstellt einen neuen array, eine kopie
    // state darf man nie direkt verändern, sondern nur über this.setState()
    const updatedTo = [...this.state[to], id];
  ...
  render() {
    const currentlyReadingObjects = books.filter(book =>
      this.state.currentlyReading.includes(book.id),
    );
    const wantToReadObjects = books.filter(book =>
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                ...
                >
                  {currentlyReadingObjects.map(book => (
                    <Book
                      key={book.id}
                      author={book.author}
                      title={book.title}
